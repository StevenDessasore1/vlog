...
Vlog.create(name: 'TheStarReport', genre: 'Media News',
...
Vlog.create(name: 'Casey Neistat', genre: 'Film',
...
Vlog.create(name: 'Vagabrothers', genre: 'Travel',
...
Vlog.create(name: 'VanossGaming', genre: 'Gaming',
...
Vlog.create(name: 'KSI', genre: 'Entertainment',
...
Vlog.create(name: 'Jasmine Brown', genre: 'Style',
